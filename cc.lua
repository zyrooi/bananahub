...
Tab1:Button("Teleport 70km",function()
    
end)
Tab1:Button("Teleport 60km",function()
    
end)
Tab1:Button("Teleport 50km",function()
    
end)
Tab1:Button("Teleport 40km",function()
    
end)
Tab1:Button("Teleport 30km",function()
    
end)
Tab1:Button("Teleport 20km",function()
