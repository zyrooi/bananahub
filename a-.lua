...
Tab1:Seperator("Esp")
Tab1:Toggle("Esp User",false,function(value)
espuse(value)
    end)
...
Tab1:Seperator("Comlect Item")
Tab1:Toggle("Comlect All Item",false,function(value)
com(value)
    end)
...
Tab1:Slider("Range Comlect",1,5,0,function(value)
        print(value)
    end)
